...
from utils.visualize_utils import  print_count_topic, print_bokeh_graph, print_top_10_word, print_top_word
#%%
class LDAModel:
    ...
    def create_lda_df(self, review_col = 'cmt_2', n_top_words = 20):
        ...
        tsne_model = TSNE(n_components=self.n_components, verbose=1, random_state=42, n_iter=500)
